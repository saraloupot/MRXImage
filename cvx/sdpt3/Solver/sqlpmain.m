...
%     plot(X{1,1});
%     Xout(iter).X=X{1,1};
%     Xout(iter).Xbest=Xbest{1,1};
%     subplot(1,2,2); plot(Xbest{1,1});
%     hfig=gcf;
%     mov(iter)=getframe(hfig);
    
    if (breakyes); break; end
end
% save(['~/Desktop/CVXResults_',dstr,'/cvxMovie'],'mov');
% save(['~/Desktop/CVXResults_',dstr,'/Xout'],'Xout');
%%---------------------------------------------------------------
%% end of main loop
%%---------------------------------------------------------------
%%
