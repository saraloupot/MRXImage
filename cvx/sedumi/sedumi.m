...
% IterationResults.init_pars = pars;
% IterationResults.init_A = A;
% IterationResults.init_K = K; 
...
while STOP == 0
    ...
    % SAVE ITERATION INFO
%     % ----------------------------------------
%     IterationResults.y(:,iter) = y;
%     IterationResults.A{iter}   = A;
%     IterationResults.y0(iter)  = y0;
%     IterationResults.pars(iter)= pars;
%     IterationResults.K(iter)   = K;
%     IterationResults.R(iter)   = R;
%     IterationResults.Rate(iter)= rate;
    % ----------------------------------------
    if pars.vplot == 1
...
%     % -----------------------------
%     IterationResults.pinf=pinf;
%     IterationResults.dinf=dinf;
%     IterationResults.normx=normx;
%     IterationResults.normy=normy;
end
% ----------------------------------------
...
%     print(['~/Desktop/CVXPlot_',dstr],'-dpng','-r0');
end
% pars.vplot=1;
% IterationResults.vlist=vlist;
...
%     IterationResults.info = info;
%     IterationResults.endx = x;
%     IterationResults.endy = y;
%     save(['~/Desktop/CVXResults_',dstr],'IterationResults');